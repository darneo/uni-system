...
//    }
//
//    private static void browseNews(Language currentLanguage, User user) {
//        User myUser = user;
...
//                    : currentLanguage == Language.RU
//                    ? "Содержание: "
//                    : "Мазмұны: ") + currentNews.getContent());
//            System.out.println((currentLanguage == Language.ENG
//                    ? "Importance Level: "
//                    : currentLanguage == Language.RU
//                    ? "Уровень важности: "
//                    : "Маңыздылық деңгейі: ") + currentNews.getLevel());
//
//            System.out.println("\n" + (currentLanguage == Language.ENG
//                    ? "Options:"
//                    : currentLanguage == Language.RU
